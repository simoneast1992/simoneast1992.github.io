...
class HeaderForm extends React.Component {
    render() {
        return (
            <form name="contact" data-netlify="true" method="POST" className="w-512px max-w-xl h-auto flex flex-col p-12 bg-white rounded-xl shadow-lg relative tracking-wide">
